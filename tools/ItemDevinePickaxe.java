...
public class ItemDevinePickaxe extends ItemPickaxe {

	public ItemDevinePickaxe() {
		super(Kingdomcraft.DevineToolMaterial);
		setCreativeTab(Kingdomcraft.KingdomCraftTab);
		setTextureName(RefStrings.MODID + ":DevinePickaxe");
		setUnlocalizedName("DevinePickaxe");
	}
