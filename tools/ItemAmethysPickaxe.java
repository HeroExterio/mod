...
public class ItemAmethysPickaxe extends ItemPickaxe {

	public ItemAmethysPickaxe() {
		super(Kingdomcraft.AmethysToolMaterial);
		setCreativeTab(Kingdomcraft.KingdomCraftTab);
		setTextureName(RefStrings.MODID + ":AmethysPickaxe");
		setUnlocalizedName("AmethysPickaxe");
	}
